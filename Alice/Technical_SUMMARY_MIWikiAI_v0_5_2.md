...
project: MIWikiAI
version: v0.5.2 (2026-05-02)
status: DRAFT — paired update with MIWikiAI_QRC v0.5.2; awaits architect ratification
quick_reference: ./MIWikiAI_Quick_Reference_Card_v0_5_2.md
prior_version: v0.5.1 (2026-05-01) — superseded by v0.5.2 minor bump
supersedes: v0.5.1 with two governance additions in QRC §3.5 and §4.4. No semantic changes elsewhere.
date: 2026-05-02
revision_note: "v0.5.2 records two new MIWikiAI rules from cycle-1/cycle-2 experience: reviewer source-access protocol (symmetric to Coder anti-silent-paraphrase rule); standardized review-bundle requirement (every _API.md cycle-2+ dispatch ships a manifest-led zip). §8 items 23-24 added; §9.2 bundle-dispatch obligation cross-referenced; §12 changelog updated."
...
*Compiled by Claude9 (Claude Opus 4.7, MIWikiAI reviewer-ID Claude9, Coder role for this artifact) on 2026-05-02 (v0.5.2). Paired with `MIWikiAI_Quick_Reference_Card_v0_5_2.md`. Phase 0.2 cycle-2 review of Common_utilities_API.md v0.2 in flight; new bundle requirement binds cycle-3+. Awaits architect ratification.*
